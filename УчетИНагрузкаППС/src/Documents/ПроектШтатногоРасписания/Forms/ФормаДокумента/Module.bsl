...
Процедура РассчитатьСтавкуПоСтроке(СтрокаТаблицы)
	...
	Если СтрокаТаблицы.КоличествоЧасовНорма = 0
		Или СтрокаТаблицы.Состояние = ПредопределенноеЗначение("Перечисление.СостоянияЗаписейШтатногоРасписания.ЗамещениеСтавки") Тогда
		СтрокаТаблицы.КоличествоСтавок = 0;	
	Иначе
