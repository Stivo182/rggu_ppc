...
Процедура ИнициализироватьДанныеДокумента(Ссылка, ДополнительныеСвойства) Экспорт
	...
	ШтатноеРасписание = РезультатПакета[1].Выгрузить();
	ШтатныеРасписанияПодразделений  = РезультатПакета[2].Выгрузить(); 
	
	ТаблицыДляДвижений.Вставить("ШтатноеРасписание", ШтатноеРасписание);
	ТаблицыДляДвижений.Вставить("ШтатныеРасписанияПодразделений", ШтатныеРасписанияПодразделений);
